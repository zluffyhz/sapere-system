...
async function initSqlite() {
    ...
    `);
        ...
        await sqliteDb.run('INSERT OR REPLACE INTO users (email, password, name, role, status) VALUES (?, ?, ?, ?, ?)', ['admin@sapere.com.br', hashedPassword, 'Admin', 'admin', 'active']);
        await sqliteDb.run('INSERT OR REPLACE INTO users (email, password, name, role, status) VALUES (?, ?, ?, ?, ?)', ['dra.maria@sapere.com.br', hashedPassword, 'Dra. Maria', 'therapist', 'active']);
