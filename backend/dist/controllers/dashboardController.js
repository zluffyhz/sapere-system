...
exports.getCalendarDashboard = exports.getDashboard = void 0;
// Simular dados que viriam do banco de dados
const getDashboardData = (userRole, userId) => {
    const baseData = {
        patients: [
    ...
    switch (userRole) {
        ...
        case 'responsible':
            ...
            return {
                ...
                activities: baseData.activities.filter(act => userPatients.some(name => act.description.includes(name)))
            };
        default:
...
const getCalendarDashboard = async (req, res) => {
    try {
        ...
        // Agrupar por dia
        const appointmentsByDay = periodAppointments.reduce((acc, apt) => {
        ...
        res.json({
            ...
            summary: {
                ...
                busiest_day: Object.entries(appointmentsByDay)
                    .reduce((max, [day, apts]) => apts.length > (max.count || 0) ? { day, count: apts.length } : max, {})
            },
            user_role: user.role
        });
    }
...
exports.getCalendarDashboard = getCalendarDashboard;
exports.default = {
    getDashboard: exports.getDashboard,
    getCalendarDashboard: exports.getCalendarDashboard
};
