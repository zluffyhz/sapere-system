...
app.post('/admin/users', authenticateToken, async (req, res) => {
  try {
    ...
    const result = await query(`
      INSERT INTO users (id, name, email, username, password, role, status, phone, created_at, updated_at) 
...
app.post('/patients', authenticateToken, async (req, res) => {
  try {
    ...
    const result = await query(`
      INSERT INTO patients (id, name, birth_date, gender, contacts, responsible, insurance, consent, observations, active, created_at, updated_at, created_by) 
      VALUES (gen_random_uuid(), $1, $2, $3, $4, $5, $6, $7, $8, true, NOW(), NOW(), $9) 
      RETURNING *
...
app.post('/appointments', authenticateToken, async (req, res) => {
  try {
    ...
    const result = await query(`
      INSERT INTO appointments (id, patient_id, professional_id, start_time, end_time, status, type, notes, created_at, updated_at, created_by) 
      VALUES (gen_random_uuid(), $1, $2, $3, $4, 'scheduled', $5, $6, NOW(), NOW(), $7) 
      RETURNING *
