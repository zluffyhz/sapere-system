        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-8">
            <div className="flex items-center space-x-6">
              <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 rounded-2xl shadow-lg transform hover:scale-105 transition-transform duration-200">
                <Users className="h-8 w-8 text-white" />
              </div>
              <div>
                <h1 className="text-4xl font-bold text-gray-900 tracking-tight mb-1">Pacientes 👥</h1>
                <p className="text-lg text-gray-500 font-medium">Gestão completa de pacientes da clínica</p>
                <div className="mt-2 px-3 py-1 bg-gradient-to-r from-blue-100 to-blue-50 rounded-full inline-block">
                  <span className="text-sm font-semibold text-blue-700">Módulo Ativo ✅</span>
                </div>
              </div>
            </div>
