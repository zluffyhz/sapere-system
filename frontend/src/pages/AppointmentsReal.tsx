...
// Interface local para formulário
...
const AppointmentsReal: React.FC = () => {
  ...
  const saveAppointments = (updatedAppointments: LocalAppointment[]) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    let updatedAppointments: LocalAppointment[];
  ...
  const handleStatusChange = (id: string, status: LocalAppointment['status']) => {
